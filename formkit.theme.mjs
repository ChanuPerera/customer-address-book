/**
  ...
  *
  * @checksum - fb6b94bfa84eca8164d4957bd480cd6aeb2a8cef4754514b88e06d90f9181904
  * @variables - 
  * @theme - starter
  **/
...
const classes = {
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:aria-selected:before:ring-neutral-300": true,
    "dark:text-neutral-100": true,
    "dark:aria-selected:!bg-neutral-700": true,
    "dark:data-[is-active]:bg-neutral-700": true,
    "dark:data-[is-active]:aria-selected:before:ring-neutral-400": true
  },
  ...
  "repeater__controls": {
    ...
    "[&>li_[disabled]]:opacity-25": true,
    "[&>li_[disabled]]:!text-neutral-500": true,
